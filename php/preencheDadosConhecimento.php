...
if(!isset($_SESSION['usuario'])){
    ...
    try {
        ...
        $sql_conhecimento = "select bc.id,
                                ...
                                pr.nome_produto,
                                p.nome_pagina,
                                date_format(bc.data_reserva, '%d/%m/%Y - %H:%i:%s') criado_em,
                                bc.reservado
        ...
        if ($res_conhecimento->num_rows == 1) {
            ...
            $response = array('codigo' => 0, 'id' => $array_conhecimento[0][0], 'nome_conhecimento' => $array_conhecimento[0][1], 'nome_usuario' => $array_conhecimento[0][2], 'produto' => $array_conhecimento[0][3], 'pagina' => $array_conhecimento[0][4], 'criado_em' => $array_conhecimento[0][5], 'reservado' => $array_conhecimento[0][6]);
            echo json_encode($response);
